"""
Django settings for fsf_ecommerce project.
...
# chat with a tutor I decided to set up AWSC9_HOST as an environment variable 
...
ROOT_URLCONF = 'fsf_ecommerce.urls'
...
WSGI_APPLICATION = 'fsf_ecommerce.wsgi.application'
...
# All files under 'media' are media files
