# This is a way of separating our static files from other files such as 
# product images, for fear of overwriting static files. So we will have 
# static files in one directory on S3 and product images in another
